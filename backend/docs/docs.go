    ...
    "paths": {
        "/admin/billing/settings": {
            ...
            "put": {
                ...
                "parameters": [
                    {
                        "description": "Prices in centavos",
                        "name": "payload",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.UpdatePlatformPricesRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/admin/subscriptions": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Filter: pending|active|inactive",
                        "name": "status",
                        "in": "query"
                    },
                    {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.MarkPaidManualRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "patch": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.SetSubscriptionStatusRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "patch": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.SetTenantPlanRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/employees": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Name or position filter",
                        "name": "search",
                        "in": "query"
                    }
                ],
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.SaveScheduleRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.NotificationPrefsRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/reports/{type}": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "sales | inventory | employees | attendance | profit | tax | receipts",
                        "name": "type",
                        "in": "path",
                        "required": true
                    },
                    ...
                    {
                        "type": "string",
                        "description": "json (default) | csv | xlsx | pdf",
                        "name": "format",
                        "in": "query"
                    }
                ],
    ...
    "definitions": {
        ...
        "dto.EmployeeRequest": {
            ...
            "properties": {
                ...
                "user_email": {
                    "description": "optional login link",
                    "type": "string"
                }
            }
        },
        ...
        "dto.SaveScheduleRequest": {
            "type": "object",
            "properties": {
                "days": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/dto.ScheduleDayInput"
                    }
                }
            }
        },
        "dto.ScheduleDayInput": {
            "type": "object",
            "required": [
                "end_time",
                "start_time"
        ...
        "dto.SetSubscriptionStatusRequest": {
            "type": "object",
            "required": [
                "status"
            ],
        ...
        "dto.UpdatePlatformPricesRequest": {
            "type": "object",
            "required": [
                "monthly_price",
                "yearly_price"
