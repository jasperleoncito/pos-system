...
- Plan-based feature gating once billing matters (uses the dormant tenants.plan — note: C5 billing plans are monthly/yearly cycles in the new subscriptions tables, separate from this column).
